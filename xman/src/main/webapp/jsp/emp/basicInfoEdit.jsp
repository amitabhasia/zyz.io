...
<script type="text/javascript">
    ...
    function searchPostNum() {
        ...
        if (window.showModalDialog) {
            var returnVal = window.showModalDialog(url, args,
                    "dialogWidth:500px;dialogHeight:550px");
            
            alert(returnVal.empPost + ' ' +returnVal.empAddress);
            
            $('#emp_basicInfo_editForm input[name="empPost"]').val(returnVal.empPost);
            $('#emp_basicInfo_editForm input[name="empAddress"]').val(returnVal.empAddress);
        } else {
            var returnVal = window.open(url,args,
